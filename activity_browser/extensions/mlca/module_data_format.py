...
Data Format of modular systems
*****************************

Modular systems can be specified in the format shown below. It is used to define and store meta-modules.
...
*Keys*:
Keys are a tuple composed of two elements, where the first refers to the database and the second to the activity, thus ('database name', 'modular-system name or uuid')
